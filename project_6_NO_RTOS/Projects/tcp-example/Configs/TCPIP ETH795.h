...
// Use care when enabling this on production networks, especially with VPNs (could tunnel broadcast traffic across 
// a limited bandwidth connection).
 ...
 */
#define MY_DEFAULT_HOST_NAME			"PIC32-MX7ck"
...
#ifdef OFFICE
// ============ Office ===================
	#define MY_DEFAULT_IP_ADDR_BYTE1        (129ul)
	#define MY_DEFAULT_IP_ADDR_BYTE2        (101ul)
	#define MY_DEFAULT_IP_ADDR_BYTE3        (222ul)
	...
	#define MY_DEFAULT_GATE_BYTE1           (129ul)
	#define MY_DEFAULT_GATE_BYTE2           (101ul)
	#define MY_DEFAULT_GATE_BYTE3           (52ul)
	#define MY_DEFAULT_GATE_BYTE4           (1ul)

	#define MY_DEFAULT_PRIMARY_DNS_BYTE1	(129ul)
	#define MY_DEFAULT_PRIMARY_DNS_BYTE2	(101ul)
	#define MY_DEFAULT_PRIMARY_DNS_BYTE3	(220ul)
...
// ========== Home =====================
	...
	#define MY_DEFAULT_IP_ADDR_BYTE4        (33ul)
 ...
 */
	...
	#define TCP_PIC_RAM_SIZE					(6184ul)
